# C:\Users\awez7\OneDrive\Desktop\Scraper incubin\whatsapp_bot_proto.py
...
def run_prototype_workflow(mock_posts):
    ...
    for post in mock_posts:
        ...
        # Note: WhatsApp APIs usually require public URLs for media files.
        # If sending via Twilio/UltraMsg, they require a public HTTP url for the image.
        # If using pywhatkit or a local automated emulator, you can pass local_img.
        ...
        # Try UltraMsg second
            ...
            # In a dry run, we count it as mock-sent
            sent = True
